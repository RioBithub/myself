...
cl = LINETCR.LINE() 
cl.login(token="Elk3yKXyieb3vpcovGxa.ll8Qsnh0s3rsED4s+BgwMG.mz6BTuWwQLw+ALvD43pjcVWNAp2p44UQ0pbaBc4Ge0s=")
cl.loginResult()
        ...
        if op.type == 26:
            ...
            if msg.contentType == 13:
              ...
              if msg.from_ in admin:
                ...
                if msg.toType == 2:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        if info.preventJoinByTicket == True:
                            u = "close"
                        else:
                            u = "open"
              ...
              if msg.from_ in admin:
                    ...
                    ki.sendText(msg.to, "Sider mandul")
                    kk.sendText(msg.to, "Mending keluar")
                    kc.sendText(msg.to, "Tuan Dev sendirian nih")
                    try:
...
#-----------------------------------------------            
              ...
              if msg.from_ in admin:
                if msg.toType == 2:
                    ...
                    if targets == []:
                        ...
                        kk.sendText(msg.to,"Gaada disini")
                        kc.sendText(msg.to,"Tuanku Dev")
                    else:
                        for target in targets:
                            try:
                                wait["blacklist"][target] = True
                                ...
                                ki.sendText(msg.to,"Tuan pintar")
                                kk.sendText(msg.to,"Dia harus")
                                kc.sendText(msg.to,"Diban")
                            except:
                                ki.sendText(msg.to,"Error")
                                kk.sendText(msg.to,"Gabisa")
                                kc.sendText(msg.to,"Tuan")
              ...
              if msg.from_ in admin:
                if msg.toType == 2:
                    ...
                    if targets == []:
                        ki.sendText(msg.to,"Not found Cv")
                        kk.sendText(msg.to,"Kamu salah tuan")
                        kc.sendText(msg.to,"Mohon benarkan")
                    else:
                        for target in targets:
                            try:
                                ...
                                json.dump(wait["blacklist"], f, sort_keys=True, indent=4,ensure_ascii=False)
                                cl.sendText(msg.to,"Succes Cv")
                                ki.sendText(msg.to,"Tuan telah")
                                kk.sendText(msg.to,"Meng-unban nya")
                                kc.sendText(msg.to,"Good job")
                            except:
                                ki.sendText(msg.to,"Succes Cv")
...
#-----------------------------------------------
            ...
            elif msg.text in ["Cv say mantan"]:
              if msg.from_ in admin:
                ki.sendText(msg.to,"Hi mantan 􀜁􀅔Har Har􏿿")
                kk.sendText(msg.to,"Ku sayang kamu􀜁􀅔Har Har􏿿")
                kc.sendText(msg.to,"Balikan yuk 􀜁􀅔Har Har􏿿")
...
#-----------------------------------------------
              ...
              if msg.from_ in admin:
                ...
                kc.sendText(msg.to,"Kalo nakal saya tampol")
#-----------------------------------------------
...
#-----------------------------------------------
              ...
              if msg.from_ in admin:
                ki.sendText(msg.to,"Aku ada")
                kk.sendText(msg.to,"disini")
                kc.sendText(msg.to,"Tuanku Dev")
                cl.sendText(msg.to,"Selalu ada untukmu,tidak seperti mantan")
#-----------------------------------------------

            elif msg.text in ["Sp","Speed","speed"]:
                start = time.time()
                cl.sendText(msg.to, "Loading Bos......")
...
#-----------------------------------------------------------------
              ...
              if msg.from_ in admin:
                cl.sendText(msg.to,"Owner:DevAlv Coowner:Naf ZeroST")
